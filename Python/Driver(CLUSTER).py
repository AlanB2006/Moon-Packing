...
N_MOONS   = 3        # Number of moons (Integer)
MOON_TYPE = "L"       # "L" (Luna), "C" (Ceres), or "P" (Pluto)
TIDES_ON  = True      # True or False
TAU       = 698       # Tidal time lag (Used only if TIDES_ON is True)
...
def run_simulation(delta_H):
    ...
    tmax = 2e4 * P_M                       # total run length in inner-moon orbits
...
if __name__ == '__main__':
    ...
    # delta_H
    par_dH = np.arange(3.5, 9, 0.01) # Luna: 9, Pluto: 7.5, Ceres: 14.0
    # C: 6.0, 13.2, 13.55
    # L: 4.4, 8.2, 8.55
    # P: 4.3 9.0 9.7
